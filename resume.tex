...
\section{Professional Experience}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      {SpaceRyde Inc}{September 2021 -- Present}
      {Senior RF Specialist}{Toronto. ON}
      \resumeItemListStart
   %     \resumeItem{Designing new products/solutions, and enhancing existing data-loggers and sensors providing wireless data about structural monitoring technology. }
        \resumeItem{I'm working with a talented team developing affordable small-satellite launch technology.}

      \resumeItemListEnd

    \resumeSubheading
      {SMT Research Ltd.}{April 2020 -- August 2021}
...
%      \resumeProjectHeading
%          {\textbf{IEEE Internet of Things Society} $|$ \emph{Member}}{2018 -- 20}
